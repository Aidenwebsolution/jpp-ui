...
var ftpString =
  "U2FsdGVkX18aCMwda1/CcmWUElO9RhbZYtjQPfvu7tCSdlZet2/X0eTzycdDr5BoKPPYwwiMoNDzCVAlvk80wjO1V4u8TBEsRf956gWkESug7IjdJMinftn2JTchSpqV";
...
var templateCacheBootstrap =
  "firstapp.run(['$templateCache', function($templateCache) {";
...
gulp.task("copy:indexhtml", function() {
  ...
  return gulp.src("./w/index.html").pipe(
    gulpCopy("./production/", {
      prefix: 1
    })
  );
...
gulp.task("copy:img", function() {
  var gulpCopy = require("gulp-copy");
  return gulp.src("./img/**").pipe(gulpCopy("./production/"));
});

gulp.task("copy:fonts", function() {
  var gulpCopy = require("gulp-copy");
  return gulp.src("./fonts/**").pipe(gulpCopy("./production/"));
});
...
gulp.task("watch:all", function() {
  ...
  gulp.watch(
    ["./**/*.html", "./sass/*.scss", "./js/*.js"],
    ["sass:development", "connect:html", "connect:js"]
  );
});
