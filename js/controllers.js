...
angular
  ...
  .controller("HomeCtrl", function(
    ...
    $scope.isCheckLoggedIn = function(value) {
      ...
      NavigationService.getAuthenticate(function(data) {
        ...
        if (data.logged_in) {
          ...
          if (value == "Game") {
            window.location =
              "http://jaipurpinkpanthers.com/beta/pantherworld/#/games";
        ...
        $scope.submitChangepassword = function(forgotPassData) {
          ...
          if (forgotPassData.newPassword && forgotPassData.confirmPassword) {
            if (forgotPassData.newPassword == forgotPassData.confirmPassword) {
              ...
              NavigationService.forgotPasswordSubmit(
                $scope.forgotPassData,
                function(data) {
                  console.log("data", data);
                  if (data == "true") {
    ...
    $scope.forgotPassDataFunction = function(data) {
      ...
      $scope.myarrOfOtpForForgotPwd1 = $scope.myarrOfOtpForForgotPwd1
        .split(",")
        .join("");
      ...
      if ($scope.myarrOfOtpForForgotPwd1.length == 4) {
        console.log(
          "$scope.myarrOfOtp1",
          $scope.myarrOfOtpForForgotPwd1.length
        );
        $scope.forgotOtpSubmitFun($scope.myarrOfOtpForForgotPwd1);
        console.log(
          "$scope.myarrOfOtpForForgotPwd1",
          $scope.myarrOfOtpForForgotPwd1
        );
      }
    };
    ...
    $scope.$on("$viewContentLoaded", function(event) {
      $timeout(function() {
        (function(d, s, id) {
          ...
          js.id = id;
          js.src =
            "//connect.facebook.net/en_US/sdk.js#xfbml=1&version=v2.5&appId=329228207248886";
    ...
    $scope.bricks = [
      {
        ...
        info:
          "The unparalleled experience of Shabeer Bapu Sharfudheen has helped us improve our game on the mat to another level."
      },
      {
        img: "img/news/n6.jpg",
        title: "Jaipur Pink Panthers",
        info:
          " A candid moment when the #Panther boss, Abhishek Bachchan decided to join the us at the lunch table, inspiring us like always. #RoarForPanthers #JaiHanuman"
      },
      {
        img: "img/news/n3.jpg",
        title: "Jaipur Pink Panthers",
        info:
          "Tie your shoe laces, get ready and get going! Kick start your holiday with a heart pumping workout to pump up for the week ahead! #RoarforPanthers #JaiHanuman"
      },
      {
      ...
      },
      {
        ...
        title: "Jaipur Pink Panthers",
        info:
          "That grip which has no escape!.Ran Singh Raniya uses all his strength to take the Dabang down with all his might. A perfect frame where you can witness strength with technique. #RoarForPanthers #JaiHanuman"
      },
      {
        img: "img/wallpapper/w7.jpg",
        title: "Jaipur Pink Panthers",
        info:
          "A swim session after a tiring practice on the mat made our day perfect and relaxing. #RoarForPanthers #JaiHanuman"
      },
      {
        img: "img/team.jpg",
        title: "Jaipur Pink Panthers",
        info:
          "A star moment when the #Panthers were joined by the legend, Daggubati Venkatesh after an epic victory in the Semi-Finals! #RoarForPanthers #JaiHanuman"
      }
    ];
    $scope.image = [
      {
    ...
    NavigationService.getLatestMatch(function(data) {
      ...
      //console.log(date1);
      //console.log(date2);
      $scope.calendarDate.from =
        $filter("date")(date1, "yyyyMMddTHHmmss") + "Z";
      ...
      if (
        $scope.latestmatch.score1 >= 0 &&
        $scope.latestmatch.score2 >= 0 &&
        ($scope.latestmatch.score1 != "" && $scope.latestmatch.score2 != "")
      )
        $scope.latestMatchOn = true;
      else $scope.latestMatchOn = false;
    });
    $scope.refreshTimer = function(eventTime) {
      ...
      $interval(function() {
        ...
        if ($scope.countdown.months < 0) $scope.countdown.months = 0;
        if ($scope.countdown.days < 0) $scope.countdown.days = 0;
        if ($scope.countdown.hours < 0) $scope.countdown.hours = 0;
        if ($scope.countdown.minutes < 0) $scope.countdown.minutes = 0;
        if ($scope.countdown.seconds < 0) $scope.countdown.seconds = 0;
  ...
  .controller("FixturesCtrl", function(
    $scope,
    TemplateService,
    NavigationService,
    $stateParams,
  ...
  .controller("GalleryInnerCtrl", function(
    $scope,
    TemplateService,
    NavigationService,
    $timeout,
  ...
  .controller("WallpapperCtrl", function(
    $scope,
    TemplateService,
    NavigationService,
    $timeout,
  ...
  .controller("WallpapperInnerCtrl", function(
    $scope,
    TemplateService,
    NavigationService,
    $timeout,
  ...
  .controller("TicketMerchandizeCtrl", function(
    $scope,
    TemplateService,
    NavigationService,
    $stateParams,
  ...
  .controller("NewsMediaCtrl", function(
    $scope,
    TemplateService,
    NavigationService,
    $timeout,
  ...
  .controller("FanCornerCtrl", function(
    $scope,
    TemplateService,
    NavigationService,
    $timeout,
    ...
    $scope.changeSelected = function() {
      $scope.register.favouriteplayer = _.map(
        _.filter($scope.players, "status"),
        "name"
      ).toString();
    };
    ...
    $scope.season1 = [
      {
        ...
        url:
          " https://insider.in/event/pro-kabaddi-league-2017-combo-passes-of-jaipur-pink-panthers/buy/shows/59b23d14471f310206b81dab/Tickets",
        embed:
          "event/pro-kabaddi-league-2017-combo-passes-of-jaipur-pink-panthers/buy/shows/59b23d14471f310206b81dab/Tickets"
      },
      {
        img: "img/seasonfive/weekday.png",
        img1: "img/seasonfive/weekdaym.png",
        url:
          " https://insider.in/event/pro-kabaddi-league-2017-combo-passes-of-jaipur-pink-panthers/buy/shows/59b23ce7471f310206b81d93/Tickets",
        embed:
          "event/pro-kabaddi-league-2017-combo-passes-of-jaipur-pink-panthers/buy/shows/59b23ce7471f310206b81d93/Tickets"
      }
    ];
    $scope.season = [
      {
        ...
        url:
          "https://insider.in/pro-kabaddi-tickets-jaipur-pink-panthers-vs-gujarat-fortune-giants-puneri-paltan-vs-bengal-warriors-oct6-2017/event",
        slug:
          "pro-kabaddi-tickets-jaipur-pink-panthers-vs-gujarat-fortune-giants-puneri-paltan-vs-bengal-warriors-oct6-2017"
      },
      {
        img: "img/seasonfive/2.png",
        url:
          "https://insider.in/pro-kabaddi-tickets-haryana-steelers-vs-telugu-titans-jaipur-pink-panthers-vs-u-mumba-oct7-2017/event",
        slug:
          "pro-kabaddi-tickets-haryana-steelers-vs-telugu-titans-jaipur-pink-panthers-vs-u-mumba-oct7-2017"
      },
      {
        img: "img/seasonfive/3.png",
        url:
          "https://insider.in/pro-kabaddi-tickets-gujarat-fortunegiants-vs-patna-pirates-jaipur-pink-panthers-vs-puneri-paltan-oct8-2017/event",
        slug:
          "pro-kabaddi-tickets-gujarat-fortunegiants-vs-patna-pirates-jaipur-pink-panthers-vs-puneri-paltan-oct8-2017"
      },
      {
        img: "img/seasonfive/4.png",
        url:
          "https://insider.in/pro-kabaddi-tickets-u-mumba-vs-tamil-thalaiva-jaipur-pink-panthers-vs-dabang-delhi-oct10-2017/event",
        slug:
          "pro-kabaddi-tickets-u-mumba-vs-tamil-thalaiva-jaipur-pink-panthers-vs-dabang-delhi-oct10-2017"
      },
      {
        img: "img/seasonfive/5.png",
        url:
          "https://insider.in/pro-kabaddi-tickets-dabang-delhi-vs-bengaluru-bulls-jaipur-pink-panthers-vs-haryana-steelers-oct11-2017/event",
        slug:
          "pro-kabaddi-tickets-dabang-delhi-vs-bengaluru-bulls-jaipur-pink-panthers-vs-haryana-steelers-oct11-2017"
      },
      {
        img: "img/seasonfive/6.png",
        url:
          "https://insider.in/pro-kabaddi-tickets-jaipur-pink-panthers-vs-up-yoddha-oct12-2017/event",
  ...
  .controller("PlayersInsideCtrl", function(
    $scope,
    $state,
    TemplateService,
    NavigationService,
  ...
  .controller("InviteFriendsCtrl", function(
    $scope,
    TemplateService,
    NavigationService,
    $timeout,
